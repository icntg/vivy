...
type System struct {
	...
	LimitCountIP  int    `mapstructure:"ip-limit-count" json:"ip-limitCount" yaml:"ip-limit-count"`
	LimitTimeIP   int    `mapstructure:"ip-limit-time" json:"ip-limitTime" yaml:"ip-limit-time"`
}
