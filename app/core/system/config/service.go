...
type Service struct {
	...
	SessionSecretInHex   string `mapstructure:"session-secret-in-hex" json:"sessionSecretInHex" yaml:"session-secret-in-hex"`
	SessionSecretInBytes []byte `mapstructure:"-" json:"-" yaml:"-"`
